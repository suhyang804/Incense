  ...
  return (
    <Box
      sx={{
        ...
        borderImage:
          "linear-gradient(to right, #FFD6F8 0%, #FFFBD6 50%, #E1FFE9 100%)",
        borderImageSlice: "2",
        display: "flex",
        flexDirection: "row",
        "&:hover": { boxShadow: "0 0 20px -5px #FF85EC" },
    ...
    >
      ...
      <Box sx={{ margin: "1rem", width: "60%" }}>
        <p onClick={onClickArticle} style={{ color: "grey" }}>
          {article.createdDate.substr(0, 16)}
        </p>
        <p
          style={{
            marginTop: "0.5rem",
        ...
        <p onClick={onClickArticle} style={{ marginTop: "1.5rem" }}>
          {article.perfumeBrand}
        </p>
        <p
          onClick={onClickArticle}
      ...
      >
        ...
        >
          ...
          />
          <p style={{ fontSize: "1.5rem", marginLeft: "0.4rem" }}>
