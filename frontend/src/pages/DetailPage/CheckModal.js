...
function CheckModal(props) {
  ...
  const reviewArticle = {
    ...
    comment: reviewValue,
    perfumeId: props.perfumeInfo.id,
    preference: starValue / 2,
  };
    ...
    <Overlay>
      <ModalWrap>
        ...
        >
          ...
          >
            <img
              style={{ marginLeft: "2rem", width: "25%" }}
              src="assets/images/935.jpg"
              alt="perfumeImage"
            />
            <Box
              sx={{
